...
var FIELDS_TO_TRUST = _defineProperty({}, TABLES.VILLAS, ['description', 'additional_info']);
...
app.controller('villaCtrl', ['$scope', '$http', 'setCookieFact', '$sce', function ($s, $h, setCookieFact, $sce) {
    ...
    function initVilla(villa) {
        ...
        villa.f12 = villa.f12 || [];
        villa.f12.forEach(function (benefitRow) {
...
//# sourceMappingURL=villa-new-js-compiled.js.map